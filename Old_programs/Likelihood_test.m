...
%                 [i_fax,i_fvx,i_las_plt,i_mas_plt,i_lvs_plt,i_mvs_plt,i_la_plt,i_ma_plt,i_lv_plt,i_mv_plt]=Likelihood_given_input(k,t_max,n,c,l,m,L,M,sig_e_as,sig_e_vs,sig_l_as,sig_l_vs,sig_m_as,sig_m_vs,sig_e_ax,sig_e_vx,sig_la,sig_ma,sig_lv,sig_mv,L_v,M_v);
                ...
                [i_fax,i_fvx,i_las_plt,i_mas_plt,i_lvs_plt,i_mvs_plt,i_la_plt,i_ma_plt,i_lv_plt,i_mv_plt,i_percept_L_a,i_percept_M_a,i_percept_L_v,i_percept_M_v]=Likelihood_given_input(k,1,n,c,l,m,L_c2,M_c2,sig_e_as_c2,sig_e_vs_c2,sig_l_as_c2,sig_l_vs_c2,sig_m_as_c2,sig_m_vs_c2,sig_e_ax_c2,sig_e_vx_c2,sig_la_c2,sig_ma_c2,sig_lv_c2,sig_mv_c2,L_v,M_v);
